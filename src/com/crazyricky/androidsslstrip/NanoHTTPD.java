...
import com.crazyricky.androidsslstrip.sslstrip.ClientRequest;
...
public class NanoHTTPD {
    ...
    public static NanoHTTPD sInstance;
    ...
    */
    ...
    public static class Response {
        ...
        public void addHeader(String name, String value) {
            ...
            ArrayList<String> lst = header.get(name);
            if (lst == null) {
         ...
         */
        public HashMap<String, ArrayList<String>> header = new HashMap<String, ArrayList<String>>();
    }
    ...
    public static final String HTTP_OK = "200 OK",
            ...
            HTTP_REDIRECT = "301 Moved Permanently", HTTP_MOVED = "302 Moved",
    ...
    public static void main(String[] args) {
        startInstance("8080", "/sdcard/");
    }

    public static void startInstance(String port, String dir) {
     ...
     */
    public static void real_main(String[] args) {
        ...
        try {
            sInstance = new NanoHTTPD(port, wwwroot);
        } catch (IOException ioe) {
    ...
    private class HTTPSession implements Runnable {
        ...
        public void run() {
            try {
                ...
                */
                ...
                // test
                String realUri = pre.getProperty("real_uri");
                // Response r = resendMessage(realUri, method, header, files);
                // Response r =
                // ServerConnection.newInstance(clientIP).sendViaHttp(realUri,
                // method, header, files);

                Response r = null;
                if (method.equalsIgnoreCase("POST")) {
                    r = ClientRequest.newInstance(header, realUri, clientIP,
                            fbuf, method).process();
                } else {
                    r = ClientRequest.newInstance(header, realUri, clientIP,
                            null, method).process();
        ...
        private void decodeHeader(BufferedReader in, Properties pre,
            ...
            try {
                ...
                pre.put("real_uri", decodePercent(uri));
        ...
        private void sendResponse(String status, String mime,
                HashMap<String, ArrayList<String>> header, InputStream data) {
            try {
                if (status == null)
                ...
                if (header != null) {
                    /*
                     * Enumeration e = header.keys(); while (
                     * e.hasMoreElements()) { String key =
                     * (String)e.nextElement(); String value =
                     * header.getProperty( key ); pw.print( key + ": " + value +
                     * "\r\n"); }
                     */
                    Set<String> keyset = header.keySet();
                    for (String key : keyset) {
                        ArrayList<String> values = header.get(key);
